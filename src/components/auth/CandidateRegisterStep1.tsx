...
interface CandidateRegisterStep1Props { form: any; onChange: (k: string, v: any) => void; errors: any }
export function CandidateRegisterStep1({ form, onChange, errors }: CandidateRegisterStep1Props) {
  return (
