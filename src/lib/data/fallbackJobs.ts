/**
 * Fallback vacancy data when Supabase is not configured.
...
export const FALLBACK_WFH_JOBS: WfhJob[] = [
  ...
  { id: 'wfh-5', title: 'Customer Associate (WFH)', company: 'Amazon', logo: 'AMZ', color: '#f97316', type: 'Full Time Remote', experience: 'Fresher', salary: '₹2.5-4 LPA', cat: 'Customer Support', qualification: 'Graduate', skills: ['Communication'], badge: 'New', badge_type: 'new', applicants: 1234, description: 'Amazon WFH support.', apply_url: 'https://www.amazon.jobs/', posted_at: new Date().toISOString(), status: 'active' },
...
export const FALLBACK_ABROAD_JOBS: AbroadJob[] = [
  { id: 'abroad-1', title: 'Cabin Crew', company: 'Emirates', logo: 'EK', country: 'UAE', location: 'Dubai, UAE', type: 'Full Time', salary: '$2,800-3,500/mo', experience: 'Fresher', category: 'Aviation', description: 'Emirates cabin crew.', apply_url: 'https://www.emiratesgroupcareers.com/', skills: ['Communication'], badge: 'New', status: 'active', posted_at: new Date().toISOString() },
  { id: 'abroad-2', title: 'Petroleum Engineer', company: 'Saudi Aramco', logo: 'SA', country: 'Saudi Arabia', location: 'Dhahran', type: 'Full Time', salary: '$8,000-15,000/mo', experience: '5-10 Yrs', category: 'Engineering', description: 'Aramco engineering role.', apply_url: 'https://www.aramcojobs.com/', skills: ['Petroleum Engineering'], badge: 'Hot', status: 'active', posted_at: new Date().toISOString() },
  { id: 'abroad-3', title: 'Nurse (ICU)', company: 'NHS UK', logo: 'NH', country: 'UK', location: 'London', type: 'Full Time', salary: '£32,000-45,000/yr', experience: '2+ Yrs', category: 'Healthcare', description: 'NHS ICU nurse.', apply_url: 'https://www.jobs.nhs.uk/', skills: ['ICU Care'], badge: 'Hot', status: 'active', posted_at: new Date().toISOString() },
  { id: 'abroad-4', title: 'Software Engineer', company: 'Google', logo: 'GGL', country: 'USA', location: 'New York', type: 'Full Time', salary: '$120,000-200,000/yr', experience: '3-6 Yrs', category: 'IT / Software', description: 'Google SWE.', apply_url: 'https://careers.google.com/', skills: ['Java', 'Python'], badge: 'Hot', status: 'active', posted_at: new Date().toISOString() },
  { id: 'abroad-5', title: 'Civil Engineer', company: 'AECOM', logo: 'AEC', country: 'UAE', location: 'Dubai', type: 'Full Time', salary: 'AED 15,000-25,000/mo', experience: '3-7 Yrs', category: 'Engineering', description: 'AECOM UAE projects.', apply_url: 'https://aecom.jobs/', skills: ['Civil Engineering'], badge: 'New', status: 'active', posted_at: new Date().toISOString() },
]
...
export const FALLBACK_PRIVATE_JOBS: Job[] = [
  ...
  { id: 'priv-2', title: 'Systems Engineer', company: 'Infosys', logo: 'IN', color: '#f59e0b', location: 'Pune', type: 'Full Time', exp: 'Fresher', salary: '₹3.5-7 LPA', cat: 'IT / Software', skills: ['Java', 'DBMS'], badge: 'Verified', applyUrl: 'https://career.infosys.com/', desc: 'Infosys fresher role.', posted: '1 day ago', verified: true, source: 'Infosys', board: 'private' },
  { id: 'priv-3', title: 'Project Engineer', company: 'Wipro', logo: 'WI', color: '#8b5cf6', location: 'Hyderabad', type: 'Full Time', exp: '0-2 Yrs', salary: '₹4-8 LPA', cat: 'IT / Software', skills: ['Java', 'Agile'], badge: 'Verified', applyUrl: 'https://careers.wipro.com/', desc: 'Wipro project engineer.', posted: '3 days ago', verified: true, source: 'Wipro', board: 'private' },
  { id: 'priv-4', title: 'Software Development Engineer', company: 'Amazon', logo: 'AM', color: '#f97316', location: 'Bangalore', type: 'Full Time', exp: '2-6 Years', salary: '₹15-45 LPA', cat: 'IT / Software', skills: ['Java', 'AWS'], badge: 'Hot', applyUrl: 'https://www.amazon.jobs/', desc: 'Amazon SDE.', posted: '6 hours ago', verified: true, source: 'Amazon', board: 'private' },
  { id: 'priv-5', title: 'Product Manager', company: 'Flipkart', logo: 'FK', color: '#ef4444', location: 'Bangalore', type: 'Full Time', exp: '3-6 Years', salary: '₹30-80 LPA', cat: 'Product', skills: ['Product Strategy'], badge: 'Hot', applyUrl: 'https://www.flipkartcareers.com/', desc: 'Flipkart PM.', posted: '3 days ago', verified: true, source: 'Flipkart', board: 'private' },
  { id: 'priv-6', title: 'Member Technical Staff', company: 'Zoho', logo: 'ZO', color: '#1847d4', location: 'Chennai', type: 'Full Time', exp: '1-4 Years', salary: '₹6-14 LPA', cat: 'IT / Software', skills: ['Java', 'C++'], badge: 'Verified', applyUrl: 'https://www.zoho.com/careers.html', desc: 'Zoho MTS.', posted: '5 days ago', verified: true, source: 'Zoho', board: 'private' },
  { id: 'priv-7', title: 'Relationship Manager', company: 'HDFC Bank', logo: 'HD', color: '#1e3a8a', location: 'Pan India', type: 'Full Time', exp: '1-4 Years', salary: '₹4-9 LPA', cat: 'Banking', skills: ['Sales'], badge: 'New', applyUrl: 'https://www.hdfcbank.com/careers', desc: 'HDFC RM.', posted: '2 days ago', verified: true, source: 'HDFC', board: 'private' },
  { id: 'priv-8', title: 'Business Technology Analyst', company: 'Deloitte', logo: 'DE', color: '#0e7490', location: 'Mumbai', type: 'Full Time', exp: '0-2 Years', salary: '₹8-14 LPA', cat: 'Consulting', skills: ['Analytics'], badge: 'New', applyUrl: 'https://www2.deloitte.com/in/en/careers.html', desc: 'Deloitte BTA.', posted: '2 days ago', verified: true, source: 'Deloitte', board: 'private' },
]
